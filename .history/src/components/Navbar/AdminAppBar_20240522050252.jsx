...
const classes = {
  ...
  listItemText: `${PREFIX}-listItemText`, // Add this class
};

const drawerWidth = 300; // Increase the drawer width
...
const Root = styled('div')(({ theme }) => ({
  ...
  [`& .${classes.listItemText}`]: { // Add styles for list item text
    color: '#D0202E',
  },
}));
        ...
        >
          <List>
            ...
            <ListItem button>
              ...
              <ListItemText primary="Tenders" classes={{ primary: classes.listItemText }} />
            </ListItem>
            <ListItem button>
              <ListItemIcon className={classes.listItemIcon}><MoreVert /></ListItemIcon>
              <ListItemText primary="Other" classes={{ primary: classes.listItemText }} />
            </ListItem>
          </List>
        </div>
      </Drawer>
