    ...
    <Root>
      ...
      >
        ...
        >
          ...
          <List>
            <ListItem button>
              <ListItemIcon sx={{ color: '#D0202E' }}><Home /></ListItemIcon> {/* Set the icon color */}
              <ListItemText primary="Home" sx={{ color: '#D0202E' }} /> {/* Set the text color */}
            </ListItem>
            <ListItem button>
              <ListItemIcon sx={{ color: '#D0202E' }}><Assignment /></ListItemIcon> {/* Set the icon color */}
              <ListItemText primary="Tenders" sx={{ color: '#D0202E' }} /> {/* Set the text color */}
            </ListItem>
            <ListItem button>
              <ListItemIcon sx={{ color: '#D0202E' }}><MoreVert /></ListItemIcon> {/* Set the icon color */}
