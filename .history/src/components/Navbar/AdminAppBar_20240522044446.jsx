      ...
      <AppBar position="fixed" className={classes.appBar}>
        <Toolbar>
          ...
          <div className={classes.navButtons}>
            <Button className={classes.button} startIcon={<Home />} sx={{ color: '#D0202E', fontWeight: 'bold' }}>
              Home
            </Button>
            <Button className={classes.button} startIcon={<Assignment />} sx={{ color: '#D0202E', fontWeight: 'bold' }}>
              Tenders
            </Button>
            <Button className={classes.button} startIcon={<MoreVert />} sx={{ color: '#D0202E', fontWeight: 'bold' }}>
              Other
            </Button>
          </div>
          <IconButton
