...
const Root = styled('div')(({ theme }) => ({
  ...
  [`& .${classes.button}`]: {
    color: '#D0202E', // Set the text color to #D0202E
  },
  [`& .${classes.menuButton}`]: {
    display: 'none',
      ...
      <AppBar position="fixed" className={classes.appBar}>
        <Toolbar>
          ...
          <div className={classes.navButtons}>
            <Button className={classes.button} startIcon={<Home />} sx={{ color: '#D0202E' }}>
              Home
            </Button>
            <Button className={classes.button} startIcon={<Assignment />} sx={{ color: '#D0202E' }}>
              Tenders
            </Button>
            <Button className={classes.button} startIcon={<MoreVert />} sx={{ color: '#D0202E' }}>
              Other
            </Button>
          </div>
          <IconButton
