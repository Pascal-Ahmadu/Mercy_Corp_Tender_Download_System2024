...
const LoginPage = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // Assuming you have the user's name stored in a variable called `name`
      const name = 'User's Name'; // Replace this with your actual variable storing the user's name
      navigate(`/admin-dashboard/home?user=${encodeURIComponent(name)}`);
    } catch (error) {
