...
const RegistrationForm = () => {
  ...
  borderRadius={2}
  sx={{
    ml: { xs: 'auto', sm: 'auto', md: 30, lg: 30 }, // Center the form on small laptop screens (sm) and larger
    width: { xs: '100%', sm: '75%', md: '50%', lg: '50%' }, // Adjust width for different screen sizes
  }}
>
